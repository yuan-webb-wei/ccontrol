...
public class DrawRangeGridNS extends SimplePortrayal2D //implements Steppable
   {
   Population pop;
   int x, y1, y2;
   ...
   double actualRadius; // max (and min = -max) values of range axes
                        ...
                        // Same as variable in DrawAgentRangeNS.java
   ...
   public DrawRangeGridNS(Population pop, double rangeWindowWidth, 
...
//      }  /* step */
   ...
   public void draw(Object object, Graphics2D graphics, DrawInfo2D info)
      ...
      displacementVal = pop.getDisplacementNS();
//System.out.printf(" in DrawRangeGridNS(draw) displacementVal %.2f\n",
//displacementVal);
